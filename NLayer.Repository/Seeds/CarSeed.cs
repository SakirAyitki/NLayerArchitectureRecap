...
public class CarSeed : IEntityTypeConfiguration<Car>
{
    public void Configure(EntityTypeBuilder<Car> builder)
    {
        builder.HasData(
            ...
            new Car {Id = 4, CreatedDate = new DateTime(2026, 11, 15),BrandId = 4, DailyPrice = 65000, isAvailable =  true, Mileage = 10000, Model = "La Ferrari", Plate = "34 GEL 34", Year = 2023},
            new Car {Id = 5, CreatedDate = new DateTime(2026, 12, 14),BrandId = 5, DailyPrice = 45000, isAvailable =  true, Mileage = 13540, Model = "GT3 Turbo", Plate = "06 BNM 112", Year = 2022}
        );
    }
}